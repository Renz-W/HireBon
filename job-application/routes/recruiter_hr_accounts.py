# ================================================================
# routes/recruiter_hr_accounts.py
#
# FIX #2 — "God Object / Large File": HR-account lifecycle
...
#   concern changes.
#
# ── IMPORTANT — how this avoids breaking existing templates ──────
# Flask does NOT allow two different Blueprint() objects to share
# the same name ('recruiter') — registering both raises
# ValueError: 'recruiter' blueprint name is already registered.
#
# So instead of creating a new Blueprint here, this file imports
# the EXISTING recruiter_bp object from routes/recruiter.py and
# attaches routes to it directly. That means:
#   - url_for('recruiter.hr_accounts') keeps working unchanged
#     in every template, because it's still the same blueprint.
#   - routes/recruiter.py doesn't need to import anything from
#     this file — it stays decoupled.
#   - app.py DOES need to import this module once, so these
#     @recruiter_bp.route(...) decorators actually execute and
#     register themselves. See the snippet at the bottom.
# ================================================================
...
# ================================================================
# WIRING — add this to app.py, near where recruiter_bp is registered:
#
#   from routes.recruiter import recruiter_bp
#   import routes.recruiter_hr_accounts   # noqa: F401 — registers HR routes onto recruiter_bp
#   app.register_blueprint(recruiter_bp)
#
# The `import routes.recruiter_hr_accounts` line MUST run before
# the app starts serving requests — Python only executes the
# @recruiter_bp.route(...) decorators in this file once the module
# is imported somewhere. The `# noqa: F401` comment just tells
# linters the import is intentional even though nothing in app.py
# directly uses the name.
# ================================================================