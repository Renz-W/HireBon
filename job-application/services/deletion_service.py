# ================================================================
# FIX — "Duplicate Code": the exact same "delete every DB row
...
#
# FIX — "Long Function": each copy was a single 150-250 line
...
def _delete_upload_file(subfolder, filename):
    ...
    if os.path.exists(path):
        try:
            ...
            # FIX: (error handling) — log instead of silently swallowing.
